...
export const options = {
    ...
    services: [
        {value: services.localLlama, label: "Local Llama (OpenAI兼容)", disabled: false},
        {value: services.openrouter, label: "OpenRouter", disabled: false},
        {value: services.gemini, label: "Gemini", disabled: false},
    ],
    display: [
        {value: 0, label: "仅译文模式"},
